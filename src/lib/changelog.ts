...
export const CHANGELOG: VoceLog[] = [
  {
    ...
    data: "2026-06-14",
    novita: [
      "Pagina Gestione accessi (solo proprietario): aggiungi/rimuovi email autorizzate senza toccare il codice",
    ],
    fix: ["Deploy automatico a produzione ad ogni push", "Segreto cron ruotato"],
  },
  {
    versione: "0.8.0",
    data: "2026-06-14",
  ...
  },
  {
    ...
    data: "2026-06-14",
    novita: [
      "Rimedi della nonna: cure fai-da-te con prodotti comuni di casa (bicarbonato, aceto, limone, fondi di caffè...)",
    ],
    fix: ["Notifiche push doppie risolte; tap sulla notifica apre l'app"],
  },
  {
    versione: "0.6.0",
    data: "2026-06-14",
